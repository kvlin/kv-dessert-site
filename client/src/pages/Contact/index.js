    ...
    return (
        <div className="row" style={{paddingTop: "3rem"}}>
            ...
            <address>
                    ...
                    <p><a target="_blank" rel="noopener noreferrer" style={{textDecoration: "none", color: "inherit"}} href="https://www.instagram.com/vsdessertstudio/">vsdessertstudio</a></p>      
                    <strong >Wechat:</strong>
                    <p>Vs_Dessert_Studio</p>
                    <strong>Address:</strong>
                    <p>
                        G108/25-29 Dixon St<br/> 
                        Haymarket<br/> 
